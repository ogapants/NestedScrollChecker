 ...
 */
public class NestedScrollView27 extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedScrollView27 v, int scrollX, int scrollY,
    ...
    public NestedScrollView27(@NonNull Context context) {
        this(context, null);
    }

    public NestedScrollView27(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollView27 nsvHost = (NestedScrollView27) host;
