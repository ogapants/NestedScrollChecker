 ...
 */
public class NestedScrollView23 extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedScrollView23 v, int scrollX, int scrollY,
    ...
    public NestedScrollView23(Context context) {
        this(context, null);
    }

    public NestedScrollView23(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollView23(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollView23 nsvHost = (NestedScrollView23) host;
