 ...
 */
public class NestedScrollView22 extends FrameLayout implements NestedScrollingParent,
    ...
    public NestedScrollView22(Context context) {
        this(context, null);
    }

    public NestedScrollView22(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollView22(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollView22 nsvHost = (NestedScrollView22) host;
