 ...
 */
public class NestedScrollView25 extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedScrollView25 v, int scrollX, int scrollY,
    ...
    public NestedScrollView25(Context context) {
        this(context, null);
    }

    public NestedScrollView25(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollView25(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollView25 nsvHost = (NestedScrollView25) host;
